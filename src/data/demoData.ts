...
export const demoAttendances: Attendance[] = [
  {
    ...
    openedAt: "2026-06-09T09:30:00",
    startedAt: "2026-06-09T09:38:00",
    finishedAt: "2026-06-09T10:25:00",
    openedBy: "user-2",
    startedBy: "user-1",
    finishedBy: "user-1",
  ...
  },
  {
    ...
    openedAt: "2026-06-02T10:00:00",
    startedAt: "2026-06-02T10:08:00",
    finishedAt: "2026-06-02T10:45:00",
    openedBy: "user-2",
    startedBy: "user-1",
    finishedBy: "user-1",
...
export const demoAnamneses: AnamnesisRecord[] = [
  {
    ...
    stepStatuses: {
      ...
      health_history: "completed",
      skin_exam: "completed",
      changes: "completed",
      edema: "completed",
      monofilament_3d: "completed",
      vibration_thermal: "completed",
      eco_itb: "skipped",
      eco_ihb: "skipped",
      glycemia: "completed",
      eva: "completed",
      podology_diagnosis: "completed",
      procedure: "completed",
      dressing: "completed",
      return: "completed",
...
export const demoAttendanceImages: AttendanceImage[] = [
  {
    ...
    notes: "Estrutura preparada para armazenamento seguro.",
    createdBy: "user-1",
